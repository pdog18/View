...
public class TurnLayoutManager extends LinearLayoutManager {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d("center = %s", center.toString());
    ...
    private void setChildOffsetsHorizontal(@Gravity int gravity,
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            final int y = gravity == Gravity.START
                    ? yOffset + layoutParams.getMarginStart()
            ...
            final String s = ((TextView) child).getText().toString();
            System.out.println(child.toString() + "   >>" + s);
