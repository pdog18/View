 ...
 */
public class PieChart2 extends PieRadarChartBase<PieData> {
    ...
    public PieChart2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieChart2(Context context, AttributeSet attrs, int defStyle) {
