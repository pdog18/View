...
fun View.animateWidth(toValue: Int, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateWidthBy(byValue: Int, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator)
        = animateWidth(width + byValue, duration, interpolator)

fun View.animateHeight(toValue: Int, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateHeightBy(byValue: Int, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator)
...
fun View.animateX(toValue: Float, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateXBy(toValue: Float, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator)
        = animateX(translationX + toValue, duration, interpolator)

fun View.animateY(toValue: Float, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateYBy(toValue: Float, duration: Long = pdog18.com.core.ext.duration, interpolator: Interpolator = pdog18.com.core.ext.interpolator)
